...
from tensorflow.python.ops.gen_math_ops import imag, real
...
def train_step(images, generator, generator_optimizer, discriminator, discriminator_optimizer, noise_dim):
...
def train(dataset, epochs, generator, generator_optimizer, discriminator, discriminator_optimizer):
    ...
    for epoch in range(epochs):
        ...
        for image_batch in dataset:
            num += len(image_batch)
            print(f"[ {epoch+1} ]===>>> total image path numbers: {num}")
            train_step(image_batch, generator, generator_optimizer, discriminator, discriminator_optimizer, noise_dim)
