...
from compute_pecision_recall import voc_eval
...
def do_python_eval(devkit_path, year, image_set, classes, output_dir = 'results'):
    ...
    for i, cls in enumerate(classes):
        ...
        print(f"detect filename {filename}")
    ...
    print('~~~~~~~~\n')
    print('Results:')
    for cls in aps_cls_dic:
        print(f"Ap for Class {cls}: \t{aps_cls_dic[cls]}")
    print(f"Mean Ap: {np.mean(list(aps_cls_dic.values()))}")
    print('\n~~~~~~~~')
    print('')
    print('--------------------------------------------------------------')
